...
handleRender s@(GlobalState { route = GameMenu }) = renderGameView s
...
handleInput e s@(GlobalState { route = GameMenu }) = handleInputGameView e s
...
handleUpdate e s@(GlobalState { route = GameMenu }) = handleUpdateGameView e s
